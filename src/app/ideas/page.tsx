  ...
  const handleArchive = async (ideaId: string) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(payload.error || "Не удалось архивировать идею");
      }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="p-4 card">
          <p className="text-xs text-text-muted">
            <kbd className="px-2 py-1 bg-qf-bg-secondary rounded text-xs border border-qf-border-secondary">⌘K</kbd> чтобы
            добавить мысль
          </p>
        </div>
      </div>
